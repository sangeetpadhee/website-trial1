...
let tata=[
    ...
    {Name:"Tata Altroz", price:"6.6-10.74 Lakh (Ex-show)", img:"https://imgd.aeplcdn.com/227x128/n/cw/ec/32597/altroz-exterior-right-front-three-quarter-80.jpeg?isig=0&q=80" },
...
let kia = [
    ...
    {Name:"Kia Carens", price:" 9 - 15 lakhs", img:"https://imgd.aeplcdn.com/227x128/n/cw/ec/144163/carens-exterior-right-front-three-quarter-5.jpeg?isig=0&q=80"},
    {Name:"Kia EV6", price:" 9 - 15 lakhs", img:"https://imgd.aeplcdn.com/227x128/n/cw/ec/114971/ev6-exterior-right-front-three-quarter-4.jpeg?isig=0&q=80"}
]
...
let hyundai = [
    {Name:"Hyundai i20 N-Line", price:"4.73 - 6.47 lakh", img:"https://imgd.aeplcdn.com/1280x720/n/cw/ec/158139/i20-n-line-exterior-right-front-three-quarter-3.jpeg?isig=0&q=80" },
...
let mahindra = [
    ...
    {Name:"Mahindra XUV700", price:"13.99 - 26.99 Lakh", img:"https://imgd.aeplcdn.com/227x128/n/cw/ec/42355/xuv700-exterior-right-front-three-quarter-3.jpeg?isig=0&q=80" },
...
let audi = [
    {Name:"Audi A3", price:"29.99 - 41.99 lakh", img:" " },
    {Name:"Audi A4", price:"42.34 - 50.84 lakh", img:" " },
    {Name:"Audi A6", price:"57.08 - 61.90 lakh", img:" " },
    {Name:"Audi A8", price:"1.57 - 9.15 crore", img:" " },
    {Name:"Audi Q2", price:"34.99 - 48.89 lakh", img:" " },
    {Name:"Audi Q5", price:"59.22 - 63.98 lakh", img:" " },
    {Name:"Audi Q7", price:"79.93 - 89.92 lakh", img:" " },
    {Name:"Audi Q8", price:"1.39 - 1.56 crore", img:" " },
    {Name:"Audi e-tron", price:"1.05 - 1.18 crore", img:" " },
    {Name:"Audi RS Q8", price:"2.07 crore", img:" " }
]; 

let bmw = [
    {Name:"BMW 2 Series Gran Coupe", price:"39.30 - 42.30 lakh", img:" " },
    {Name:"BMW 3 Series", price:"43.60 - 62.90 lakh", img:" " },
    {Name:"BMW 5 Series", price:"63.40 - 72.90 lakh", img:" " },
    {Name:"BMW 7 Series", price:"1.46 - 2.44 crore", img:" " },
    {Name:"BMW X1", price:"37.20 - 42.90 lakh", img:" " },
    {Name:"BMW X3", price:"56.00 - 61.90 lakh", img:" " },
    {Name:"BMW X5", price:"76.50 - 86.90 lakh", img:" " },
    {Name:"BMW X7", price:"1.08 - 1.26 crore", img:" " },
    {Name:"BMW Z4", price:"71.90 - 73.50 lakh", img:" " },
    {Name:"BMW M8", price:"2.18 crore", img:" " }
]; 

let mercedes = [
    {Name:"Mercedes A-Class Limousine", price:"41.53 - 47.28 lakh", img:" " },
    {Name:"Mercedes C-Class", price:"44.05 - 55.40 lakh", img:" " },
    {Name:"Mercedes E-Class", price:"64.80 - 81.90 lakh", img:" " },
    {Name:"Mercedes S-Class", price:"1.65 - 2.72 crore", img:" " },
    {Name:"Mercedes GLA", price:"43.60 - 57.63 lakh", img:" " },
    {Name:"Mercedes GLC", price:"58.66 - 63.70 lakh", img:" " },
    {Name:"Mercedes GLE", price:"77.61 - 1.26 crore", img:" " },
    {Name:"Mercedes GLS", price:"1.05 - 1.97 crore", img:" " },
    {Name:"Mercedes AMG GT", price:"2.55 - 2.79 crore", img:" " },
    {Name:"Mercedes EQC", price:"1.06 crore", img:" " }
]; 

let astonMartin = [
    {Name:"Aston Martin Vantage", price:"3.00 crore", img:" " },
    {Name:"Aston Martin DB11", price:"3.80 crore", img:" " },
    {Name:"Aston Martin DBS Superleggera", price:"5.79 crore", img:" " },
    {Name:"Aston Martin Rapide", price:"3.29 crore", img:" " },
    {Name:"Aston Martin DBX", price:"3.82 crore", img:" " },
    {Name:"Aston Martin Valhalla", price:"4.00 crore", img:" " },
    {Name:"Aston Martin V12 Speedster", price:"5.00 crore", img:" " },
    {Name:"Aston Martin Valkyrie", price:"21.65 crore", img:" " },
    {Name:"Aston Martin Vanquish", price:"3.85 crore", img:" " },
    {Name:"Aston Martin Lagonda", price:"5.75 crore", img:" " }
]; 

let lamborghini = [
    {Name:"Lamborghini Huracan", price:"3.22 - 4.10 crore", img:" " },
    {Name:"Lamborghini Aventador", price:"5.01 - 6.25 crore", img:" " },
    {Name:"Lamborghini Urus", price:"3.10 - 4.10 crore", img:" " },
    {Name:"Lamborghini Sián", price:"3.00 crore", img:" " },
    {Name:"Lamborghini Centenario", price:"5.00 crore", img:" " },
    {Name:"Lamborghini Reventon", price:"8.00 crore", img:" " },
    {Name:"Lamborghini Veneno", price:"8.00 crore", img:" " },
    {Name:"Lamborghini Murciélago", price:"4.00 crore", img:" " },
    {Name:"Lamborghini Countach", price:"7.00 crore", img:" " },
    {Name:"Lamborghini Gallardo", price:"2.00 crore", img:" " }
]; 

let ferrari = [
    {Name:"Ferrari Roma", price:"3.76 crore", img:" " },
    {Name:"Ferrari Portofino", price:"3.50 crore", img:" " },
    {Name:"Ferrari F8 Tributo", price:"4.02 crore", img:" " },
    {Name:"Ferrari 812 Superfast", price:"5.21 crore", img:" " },
    {Name:"Ferrari SF90 Stradale", price:"7.00 crore", img:" " },
    {Name:"Ferrari GTC4Lusso", price:"4.26 crore", img:" " },
    {Name:"Ferrari Monza SP1", price:"9.45 crore", img:" " },
    {Name:"Ferrari LaFerrari", price:"12.00 crore", img:" " },
    {Name:"Ferrari Enzo", price:"6.87 crore", img:" " },
    {Name:"Ferrari F40", price:"20.00 crore", img:" " }
]; 

let landRover = [
    {Name:"Land Rover Discovery Sport", price:"65.30 - 69.04 lakh", img:" " },
    {Name:"Land Rover Defender", price:"78.59 - 91.68 lakh", img:" " },
    {Name:"Land Rover Range Rover Evoque", price:"66.00 - 69.53 lakh", img:" " },
    {Name:"Land Rover Range Rover Velar", price:"79.87 - 86.84 lakh", img:" " },
    {Name:"Land Rover Discovery", price:"88.07 - 1.21 crore", img:" " },
    {Name:"Land Rover Range Rover Sport", price:"92.38 - 1.74 crore", img:" " },
    {Name:"Land Rover Range Rover", price:"2.01 - 4.34 crore", img:" " },
    {Name:"Land Rover Range Rover Sport SVR", price:"2.19 crore", img:" " },
    {Name:"Land Rover Range Rover SV Autobiography", price:"4.08 - 4.34 crore", img:" " },
    {Name:"Land Rover Defender V8", price:"2.40 crore", img:" " }
]; 

let porsche = [
    {Name:"Porsche 718 Cayman", price:"85.46 lakh", img:" " },
    {Name:"Porsche 718 Boxster", price:"89.52 lakh", img:" " },
    {Name:"Porsche 911", price:"1.67 - 3.09 crore", img:" " },
    {Name:"Porsche Taycan", price:"1.50 - 2.07 crore", img:" " },
    {Name:"Porsche Panamera", price:"1.45 - 2.44 crore", img:" " },
    {Name:"Porsche Macan", price:"69.98 - 85.03 lakh", img:" " },
    {Name:"Porsche Cayenne", price:"1.20 - 1.92 crore", img:" " },
    {Name:"Porsche 911 Turbo S", price:"3.08 crore", img:" " },
    {Name:"Porsche Cayman GT4", price:"1.64 crore", img:" " },
    {Name:"Porsche 911 GT3 RS", price:"2.89 crore", img:" " }
]; 

let volvo = [
    {Name:"Volvo S60", price:"45.90 - 58.99 lakh", img:" " },
    {Name:"Volvo S90", price:"61.90 - 65.90 lakh", img:" " },
    {Name:"Volvo XC40", price:"42.90 - 62.90 lakh", img:" " },
    {Name:"Volvo XC60", price:"61.90 - 65.90 lakh", img:" " },
    {Name:"Volvo XC90", price:"89.90 - 1.31 crore", img:" " },
    {Name:"Volvo V90 Cross Country", price:"65.31 lakh", img:" " },
    {Name:"Volvo S60 Polestar", price:"67.90 lakh", img:" " },
    {Name:"Volvo XC40 Recharge", price:"70.90 lakh", img:" " },
    {Name:"Volvo XC90 Excellence", price:"1.33 crore", img:" " },
    {Name:"Volvo XC60 Polestar", price:"69.90 lakh", img:" " }
]; 
...
const showInHtml = tata.map((project, index)=>{
    ...
    <div class="carimg">
                    <img src="${project.img}" alt="" class="imgallcarlist">
                </div>
                <span class="nameprice">
               <span class="carnameallcarlist" style="font-size: 17px;" >${project.Name}</span>
               <span class="priceallcarlist">${project.price}</span></span>
     </div>
     </div>
    `
})
...
function hatch(){
    ...
    const bodyshowInHtml = hatchh.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
            <span class="bycarnameallcarlist" style="font-size: 17px;" >${project.Name}</span>
            <span class="bypriceallcarlist">${project.price}</span></span>
...
const bodylist = document.querySelector(".bodyallcar");
bodylist.style.height="300px";
const bodyshowInHtml = sedann.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".bodyallcar");
bodylist.style.height="300px";
const bodyshowInHtml = suvv.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".bodyallcar");
bodylist.style.height="300px";
const bodyshowInHtml = muvv.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
function onetofive(){
    const bodylist = document.querySelector(".priceallcar");
    bodylist.style.height="300px";
    const bodyshowInHtml = belowfive.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
...
function fivetoten(){
    const bodylist = document.querySelector(".priceallcar");
    bodylist.style.height="300px";
    const bodyshowInHtml = belowten.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
...
function tentofifteen(){
    const bodylist = document.querySelector(".priceallcar");
    bodylist.style.height="300px";
    const bodyshowInHtml = belowfifteen.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
...
function fifteentothirty(){
    const bodylist = document.querySelector(".priceallcar");
    bodylist.style.height="300px";
    const bodyshowInHtml = belowthirty.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
...
function abovethirty(){
    const bodylist = document.querySelector(".priceallcar");
    bodylist.style.height="300px";
    const bodyshowInHtml = abovethirt.map((project, index)=>{
        return`
        <div class="byallcarlist">
            <div class="bycarimg" style="background-image: url(${project.img});;"></div>
            <span class="bynameprice">
...
bodylist.style.height="300px";
const bodyshowInHtml = marutisuzuki.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = toyota.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = mahindra.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = kia.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = skoda.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = mg.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = honda.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = jeep.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = renault.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = citroen.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = volkswagen.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = bmw.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = audi.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = mercedes.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = landRover.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = porsche.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = lamborghini.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = ferrari.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = volvo.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
...
const bodylist = document.querySelector(".compmakeallcar");
bodylist.style.height="300px";
const bodyshowInHtml = astonMartin.map((project, index)=>{
    return`
    <div class="byallcarlist">
        <div class="bycarimg" style="background-image: url(${project.img});;"></div>
        <span class="bynameprice">
